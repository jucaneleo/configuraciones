...
(use-package dashboard
  ...
  (setq dashboard-banner-logo-title "Que pasa pisha")
  ;;(setq dashboard-startup-banner 'logo) ;; use standard emacs logo as banner
  (setq dashboard-startup-banner "~/Images/emacs.png")  ;; use custom image as banner
...
(custom-set-variables
 ...
 '(package-selected-packages
   '(dracula-theme vterm smex sudo-edit rainbow-delimiters use-package)))
(custom-set-faces
